...
<body class="login-page login-page-<?= $Settings->theme_style; ?> rtl rtl-inv">
    <div class="login-box">
        <div class="login-logo">
            <a href="<?=base_url();?>"><?= $Settings->site_name == 'FAZAL STORE' ? 'FAZAL<b>STORE</b>' : '<img src="'.base_url('uploads/Logo.png.png').'"style="width:280px;height:auto;display:block;margin:-10px auto -50px auto;padding:0;" alt="'.$Settings->site_name.'" />'; ?></a>
        </div>
