    ...
    <div class="modal-dialog" role="document"<?= $Settings->rtl ? ' dir="rtl"' : ''; ?>>
        <div class="modal-content">
            <div class="modal-body">
                ...
                ?>
                <div id="wrapper">
                    <div id="receiptData" style="width: auto; max-width: 580px; min-width: 250px; margin: 0 auto; font-family: 'Roboto', sans-serif;">
                        <div class="no-print">
                            <?php if ($message) { ?>
                        ...
                        <div id="receipt-data">
                            <div>
                                <div style="text-align:center;">
                                    <?php
                                     if ($store) {
                                        echo '<img src="'.base_url('uploads/Logo.png.png').'" style="width:280px;height:auto;display:block;margin:-10px auto -50px auto;padding:0;" alt="Logo">';
                                        //echo '<img src="'.base_url('uploads/Logo.png.png').'" style="width: 300px; height: auto;" alt="Logo">';
                                    ...
                                    // if ($store) {
                                    //     echo '<img src="'.base_url('uploads/Logo.png.png').'" style="width:250px;height:auto;display:block;margin:-10px auto -50px auto;padding:0;" alt="Logo">';
                                        
                                    //     echo '<p style="text-align:center;margin:0;padding:0;line-height:1.2;">';
                                    //     echo trim($store->address1).'<br>';
                                    //     echo trim($store->address2).'<br>';
                                    //     echo trim($store->city).'<br>';
                                    //     echo trim($store->phone);
                                    //     echo '</p>';
                                        
                                    //     echo '<p style="margin:0;padding:0;">'.nl2br(trim($store->receipt_header)).'</p>';
                                    // }
                                    ?>
                                </div>
                                <p>
                                ...
                                <table class="table table-striped table-condensed">
                                    <thead>
                                        <tr>
                                            <th class="text-center" style="width: 50%; border-bottom: 2px solid #ddd;"><?=lang('Item');?></th>
                                            <th class="text-center" style="width: 12%; border-bottom: 2px solid #ddd;"><?=lang('Qty');?></th>
                                            <th class="text-center" style="width: 24%; border-bottom: 2px solid #ddd;"><?=lang('Price');?></th>
                                            <th class="text-center" style="width: 26%; border-bottom: 2px solid #ddd;"><?=lang('Total');?></th>
                                        </tr>
                                    </thead>
                                    <tbody>
                                        <?php
                                ...
                                if ($payments) {
                                    ...
                                    foreach ($payments as $payment) {
                                        ...
                                        if ($payment->paid_by == 'cash' && $payment->pos_paid) {
                                            echo '<tr>';
                                            echo '<td class="text-right"><strong>' . lang("paid_by") . ' :</td><td>' . lang($payment->paid_by) . '</td>';
                                            echo '</tr>';
                                        
                                            echo '<tr>';
                                            echo '<td class="text-right"><strong>' . lang("amount") . ' :</td><td>' . $this->tec->formatMoney($payment->pos_paid == 0 ? $payment->amount : $payment->pos_paid) . '</td>';
                                            echo '</tr>';
                                        
                                            echo '<tr>';
                                            echo '<td class="text-right"><strong>' . lang("change") . ' :</td><td>' . ($payment->pos_balance > 0 ? $this->tec->formatMoney($payment->pos_balance) : 0) . '</td>';
                                            echo '</tr>';
                                        }
